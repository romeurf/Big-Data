...
# =============================================================================
# 2. Padronização dos Nomes dos Países
# =============================================================================
def standardize_country_names(df, country_col):
    ...
    if country_col in df_std.columns:
        ...
        df_std[country_col] = df_std[country_col].str.strip().str.title()
        ...
        df_std[country_col] = df_std[country_col].replace(special_cases)

    return df_std

# =============================================================================
# 3. Função para preparar os DataFrames
# =============================================================================
...
# =============================================================================
# 4. Função para mesclar DataFrames e tratar valores duplicados
# =============================================================================
...
df_country_selected = df_country[['name', 'gdp', 'life_expectancy_male', 'unemployment', 'imports', 
                                  ...
                                  'population', 'secondary_school_enrollment_male', 'pop_growth', 'region', 
...
# =============================================================================
# 7. Verificar e exibir países com múltiplas entradas antes da mesclagem final
# =============================================================================
print("Verificando países com múltiplas entradas antes da mesclagem final:")
for df, name in zip([df_WHR_prep, df_country_prep, df_social_prep, df_suicide_prep], 
                    ["WHR", "Country", "Social", "Suicide"]):
    duplicates = df[df.duplicated(subset=['country'], keep=False)]
    if not duplicates.empty:
        print(f"\nDuplicatas encontradas no DataFrame {name}:")
        print(duplicates)
...
output_filename = 'merged_dataset_final.xlsx'
